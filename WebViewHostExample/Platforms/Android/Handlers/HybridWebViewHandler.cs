...
namespace WebViewHostExample.Platforms.Droid.Renderers
{
    public class HybridWebViewHandler : ViewHandler<IHybridWebView, Android.Webkit.WebView>
    {
        ...
        protected override Android.Webkit.WebView CreatePlatformView()
        {
            ...
            webView.SetWebViewClient(new JavascriptWebViewClient($"javascript: {JavascriptFunction}",this));
    ...
    public class JavascriptWebViewClient : WebViewClient
    {
        ...
        public JavascriptWebViewClient(string javascript, HybridWebViewHandler hybridRenderer)
        {
        ...
        public override void OnPageFinished(Android.Webkit.WebView view, string url)
        {
            ...
            Console.WriteLine("Termina de cargar página");
            HybridWebViewHandler hybridRenderer;


            if (hybridWebViewRenderer != null && hybridWebViewRenderer.TryGetTarget(out hybridRenderer))
            {
                hybridRenderer.VirtualView.CallNavigate(false);
            }
        }
    }
